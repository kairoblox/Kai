...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "CLAYKingModXAppleMod"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://110194207116876"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://110194207116876"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			Name = "Ẩn Menu",
			Content = "Nhấn Phím Shift Để Mở Lại Giao Diện.",
			Time = 5
		})
